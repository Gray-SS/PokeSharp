...
public abstract class Logger
{
    ...
    public void Trace(string message,
                      ...
                      [CallerMemberName] string? callerMemberName = null)
    {
        Log(LogLevel.Trace, message, null, callerFilePath, callerMemberName);
    }
    ...
    public void Debug(string message,
                     ...
                     [CallerMemberName] string? callerMemberName = null)
    {
        Log(LogLevel.Debug, message, null, callerFilePath, callerMemberName);
    }
    ...
    public void Info(string message,
                     ...
                     [CallerMemberName] string? callerMemberName = null)
    {
        Log(LogLevel.Info, message, null, callerFilePath, callerMemberName);
    }
    ...
    public void Warn(string message,
                     ...
                     [CallerMemberName] string? callerMemberName = null)
    {
        Log(LogLevel.Warn, message, null, callerFilePath, callerMemberName);
    }
    ...
    public void Error(string message,
                      ...
                      [CallerMemberName] string? callerMemberName = null)
    {
        Log(LogLevel.Error, message, exception, callerFilePath, callerMemberName);
    }
    ...
    public void Fatal(string message,
                      ...
                      [CallerMemberName] string? callerMemberName = null)
    {
        Log(LogLevel.Fatal, message, exception, callerFilePath, callerMemberName);
    }
}

public abstract class Logger<T> : Logger
{
}