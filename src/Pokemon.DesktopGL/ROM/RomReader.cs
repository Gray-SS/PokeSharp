...
public class RomReader
{
    ...
    public virtual T ReadStruct<T>(int baseOffset) where T : unmanaged
    {
    ...
    public virtual T ReadStruct<T>(int baseOffset, int offset) where T : unmanaged
        => ReadStruct<T>(baseOffset + offset);
